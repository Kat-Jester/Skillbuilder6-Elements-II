# Skill Builder 6 - LeetCode!

## Student OutcomesSkillBuilder6
...
```
SkillBuilder6.lastItemReachable(new int[]{5, 3, 2, 1, 0, 2, 3});
```
...
```
SkillBuilder6.lastItemReachable(new int[]{3, 3, 1, 0, 1, 3});
```
...
```
SkillBuilder6.slidingWindowMin(new int[] {14, 92, 3, -7, 18, -9, 47, -12}, 4)
```
...
```
SkillBuilder6.slidingWindowMin(new int[] {14, 92, 3, -7}, 4)
```
